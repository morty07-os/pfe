  ...
  return (
    <>
          ...
          >
            <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              <TextField
                ...
                value={
                  formData.location ? "Pickup Location Set ✓" : "Click to set pickup location"
                }
                sx={{
                  cursor: "pointer",
                  "& .MuiInputBase-input": {
                ...
                InputProps={{
                  ...
                  startAdornment: (
                    <InputAdornment position="start">
                      <LocationOnIcon
                        sx={{ color: formData.location ? "#475569" : "#64748b" }}
                      />
                    </InputAdornment>
                  ),
                  endAdornment: formData.location ? (
                    <InputAdornment position="end">
                      <Typography
                        variant="caption"
                        sx={{ color: "#475569", fontWeight: 500, mr: 1 }}
                      >
                        Click to change
                      </Typography>
                    </InputAdornment>
      ...
      >
        ...
        <DialogContent
          sx={{ p: 0, position: "relative", display: "flex", flexDirection: "column", height: "100%" }}
        >
